...
1. common.h lines 92-101: CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR array with ~6 LPWSTR initializations from string literals (const wchar_t[] to LPWSTR)
2. common.h lines 104-108: CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR array with ~3 LPWSTR initializations from string literals
3. helpers.cpp line 139: PWSTR from string literal (L"")

Note: Lines 70 and 81 (FIELD_STATE_PAIR arrays) contain only enum values and do NOT cause C2440 errors.
...
<task type="auto">
  ...
  <action>
    ...
    Change at the following lines ONLY:
    ...
    DO NOT modify lines 70 or 81 (FIELD_STATE_PAIR arrays) - they contain only enum values and do not cause C2440 errors.
...
<verification>
1. All ~13 C2440 const-correctness errors in EIDCredentialProvider are fixed
