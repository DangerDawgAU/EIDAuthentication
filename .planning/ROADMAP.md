...
Plans:
- [ ] 03-01: Add `std::to_underlying` for enum conversions
- [ ] 03-02: Extend `constexpr` to validation routines
- [ ] 03-03: Apply `if consteval` and `std::unreachable` where beneficial
