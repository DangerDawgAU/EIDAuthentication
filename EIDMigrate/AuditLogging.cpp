...
PCWSTR GetEventTypeString(EID_AUDIT_EVENT_TYPE eventType)
{
    ...
    // BUG FIX #21: Additional event types
    case 10: return L"USER_CREATED";           // EID_AUDIT_EVENT_TYPE::USER_CREATED
    case 11: return L"GROUP_CREATED";          // EID_AUDIT_EVENT_TYPE::GROUP_CREATED
    case 12: return L"CERTIFICATE_INSTALLED";  // EID_AUDIT_EVENT_TYPE::CERTIFICATE_INSTALLED
    case 13: return L"CERTIFICATE_VALIDATION_FAILED"; // EID_AUDIT_EVENT_TYPE::CERTIFICATE_VALIDATION_FAILED
    case 14: return L"RATE_LIMIT_EXCEEDED";    // EID_AUDIT_EVENT_TYPE::RATE_LIMIT_EXCEEDED
    case 15: return L"CREDENTIAL_EXPORT_START"; // EID_AUDIT_EVENT_TYPE::CREDENTIAL_EXPORT_START
    case 16: return L"CREDENTIAL_IMPORT_START"; // EID_AUDIT_EVENT_TYPE::CREDENTIAL_IMPORT_START
    case 17: return L"LSA_ACCESS";             // EID_AUDIT_EVENT_TYPE::LSA_ACCESS
